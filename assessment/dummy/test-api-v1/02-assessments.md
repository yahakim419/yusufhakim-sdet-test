...
- **curl:**
  ...
  ```
- **Expected status:** `422`
- **Expected message:** (ActiveRecord presence message, typically includes `Name`)
- **Expected payload (validate):**
  - `errors[0].status` == `422`
...
### TC-ASM-004 — Get assessment by id
- **Priority:** P0
...
### TC-ASM-005 — Get assessment not found
- **Priority:** P1
- **Method / Path:** `GET /api/v1/assessments/:id`
- **Auth:** Bearer JWT
- **curl:**
...
### TC-ASM-007 — Delete assessment
- **Priority:** P1
- **Method / Path:** `DELETE /api/v1/assessments/:id`
- **Auth:** Bearer JWT
- **Precondition:** Use a disposable assessment id (create one dedicated for delete), not `$ASSESSMENT_ID` needed by later suites
- **curl:**
  ```bash
...
### TC-ASM-008 — Delete assessment not found
- **Priority:** P2
- **Method / Path:** `DELETE /api/v1/assessments/:id`
- **Auth:** Bearer JWT
- **curl:**
